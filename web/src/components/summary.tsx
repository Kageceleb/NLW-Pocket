...
export function Summary() {
    ...
    const progressIndicatorPerCent = Math.round((data.completed * 100) / data.total)
        ...
        <div className="py-10 max-w-[480px] px-5 mx-auto flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3">
                <Progress value={data.completed} max={data.total}>
                    <ProgressIndicator style={{ width: `${progressIndicatorPerCent}%` }} />
                </Progress>
                    ...
                    return (
                        <div key={date} className="flex flex-col gap-4">
                            <h3 className="font-medium">
                                ...
                                <span className="text-zinc-400 text-xs">({formatedDate})</span></h3>
